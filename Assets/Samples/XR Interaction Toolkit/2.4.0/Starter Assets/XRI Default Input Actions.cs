...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""62c49151-ebc0-4f4e-ba22-15c6a1592d2e"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""7999a454-8dfb-4da0-855e-14d63eb9bcf8"",
                    ""path"": ""<Keyboard>/t"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""6f81f759-211c-4d44-98e2-0a1a75d21c81"",
                ...
                {
                    ""name"": """",
                    ""id"": ""327e792c-aef4-4fd3-9129-7d38ac7fa780"",
                    ""path"": ""<Keyboard>/t"",
                    ""interactions"": ""Hold(duration=1.401298E-45)"",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Test"",
            ""id"": ""4de7bc9e-972b-4212-8e39-98038f6f11fa"",
            ""actions"": [
                {
                    ""name"": ""tst action"",
                    ""type"": ""Button"",
                    ""id"": ""ac2a1f47-ae7e-4646-90d5-6b284cd750fb"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""6b0a3150-5b3e-4927-b553-811bcf3d3cbd"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""b33c56d6-cbef-4f1c-b7de-f7b5e531dee7"",
                    ""path"": ""<Keyboard>/t"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHandInteraction_ActivateRelease = m_XRIRightHandInteraction.FindAction("Activate Release", throwIfNotFound: true);
        ...
        m_Test_tstaction = m_Test.FindAction("tst action", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        Debug.Assert(!m_Test.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.Test.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_XRIRightHandInteraction_ActivateRelease;
    ...
    public struct XRIRightHandInteractionActions
    {
        ...
        public InputAction @ActivateRelease => m_Wrapper.m_XRIRightHandInteraction_ActivateRelease;
        ...
        public void AddCallbacks(IXRIRightHandInteractionActions instance)
        {
            ...
            @Activate.performed += instance.OnActivate;
            @Activate.canceled += instance.OnActivate;
            @ActivateRelease.started += instance.OnActivateRelease;
            @ActivateRelease.performed += instance.OnActivateRelease;
            @ActivateRelease.canceled += instance.OnActivateRelease;
            @ActivateValue.started += instance.OnActivateValue;
            @ActivateValue.performed += instance.OnActivateValue;
            @ActivateValue.canceled += instance.OnActivateValue;
            @UIPress.started += instance.OnUIPress;
    ...
    private readonly InputAction m_Test_tstaction;
    public struct TestActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public TestActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @tstaction => m_Wrapper.m_Test_tstaction;
        ...
        public void AddCallbacks(ITestActions instance)
        {
            ...
            @tstaction.started += instance.OnTstaction;
            @tstaction.performed += instance.OnTstaction;
            @tstaction.canceled += instance.OnTstaction;
        }
    ...
    public interface IXRIRightHandInteractionActions
    {
        ...
        void OnSelectValue(InputAction.CallbackContext context);
        void OnActivate(InputAction.CallbackContext context);
        void OnActivateRelease(InputAction.CallbackContext context);
        void OnActivateValue(InputAction.CallbackContext context);
        void OnUIPress(InputAction.CallbackContext context);
        void OnUIPressValue(InputAction.CallbackContext context);
        void OnUIScroll(InputAction.CallbackContext context);
    ...
    {
        void OnTstaction(InputAction.CallbackContext context);
    }
}
